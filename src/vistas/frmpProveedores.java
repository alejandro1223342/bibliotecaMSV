...
public class frmpProveedores extends javax.swing.JPanel {

   
    DefaultTableModel modelo = new DefaultTableModel();

    public frmpProveedores() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "CREDITO", "DE CONTADO" }));
